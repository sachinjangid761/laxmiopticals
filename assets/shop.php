...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item shop-menu">
                        <a href='shop.php' class="nav-link started">Shop</a>
                    </li>
                    <li class="nav-item shop-menu">
    ...
    <div style='height:100px' class="filter">
        <div style="float:left" class="select">
            <select name="filters" id="">
                <option value="" selected>filter your catagories</option>
                <option value="">filter 1</option>
                <option value="">filter 2</option>
            </select>
        </div>
        <div style="float:right;text-align:center;" class="search">
            <form action="" method="post">
                <input type="text" name="search_input" id="search" placeholder="search...">
    ...
    <div class="container">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                <div class="card">
                    <img style="width:100%;height:160px" src="https://via.placeholder.com/150" class="card-img-top"
                        alt="Product Image">
                    <div class="card-body">
